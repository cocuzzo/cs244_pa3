...
ingress_config_1 = \
  [ ({core.IN_PORT : host0},
     ...
     ({core.DL_TYPE : ethernet.IP_TYPE, core.NW_DST : host0_ip},
      [ forward(ingress_port_map[host0]) ]),
     ({core.DL_TYPE : ethernet.IP_TYPE, core.NW_DST : host1_ip},
      [ forward(ingress_port_map[host1]) ]),
     ({core.DL_TYPE : ethernet.IP_TYPE, core.NW_DST : host2_ip},
      [ forward(ingress_port_map[host2]) ]),
     ({core.DL_TYPE : ethernet.IP_TYPE, core.NW_DST : host3_ip},
      [ forward(ingress_port_map[host3]) ]),
       # ARP
    ({core.DL_TYPE : ethernet.ARP_TYPE, core.IN_PORT : ingress_port_map[leftFilter]},
     [ forward(ingress_port_map[host0]),
       forward(ingress_port_map[host1]),
       forward(ingress_port_map[host2]),
       forward(ingress_port_map[host3]) ])  ]
...
leftFilter_config_1 = \
  [ ({core.DL_TYPE : ethernet.IP_TYPE,
      ...
      core.IN_PORT : 1},
     [ forward(2) ]),
    ({core.DL_TYPE : ethernet.ARP_TYPE, core.IN_PORT : 1},
     [ forward(2) ]),                                                    
    ({core.IN_PORT : 2},
     [ forward(1) ]) ]
                                                 
middleFilter_config_1 = [ ({core.IN_PORT : 1},
                           [ forward(2) ]),
                          ({core.IN_PORT : 2},
                           [ forward(1) ]) ]

rightFilter_config_1 = [ ({core.IN_PORT : 1},
                          [ forward(2) ]),
                         ({core.IN_PORT : 2},
                          [ forward(1) ]) ]

egress_config = [ ({core.IN_PORT : 1},
                   [ forward(4) ]),
                  ({core.IN_PORT : 2},
                   [ forward(4) ]),
                  ({core.IN_PORT : 3},
...
ACL1 = policy_of_dict({ ingress      : ingress_config_1,
...
rightFilter_config_2 = [ ({core.IN_PORT : 1},
                          [ forward(2) ]),
                         ({core.IN_PORT : 2},
                          [ forward(1) ]) ]

ACL2 = policy_of_dict({ ingress      : ingress_config_2,
